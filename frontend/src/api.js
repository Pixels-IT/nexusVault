...
const api = {
  ...
  webhookConfig:    () => request('GET', '/webhook/config'),
  webhookSave:      (d) => request('PUT', '/webhook/config', d),
  webhookTest:      () => request('POST', '/webhook/test'),
  webhookValidate:  (code) => request('POST', '/webhook/validate', { code }),
  webhookReset:     () => request('DELETE', '/webhook/config'),
  ...
  oidcExchange:  (d) => request('POST', '/oidc/exchange', d),
  ...
  dbExportConfig:      ()      => request('GET',    '/db-export-config'),
  dbExportSaveConfig:  (type, d) => request('PUT',  `/db-export-config/${type}`, d),
  dbExportTest:        (type, d) => request('POST', `/db-export/test/${type}`, d),
