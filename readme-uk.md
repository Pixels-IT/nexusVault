...
- **Audited actions: LOGIN_SUCCESS/FAIL/BLOCKED, LOGOUT/TIMEOUT, BACKUP_*, AUDIT_ARCHIVED, BRUTE_CONFIG_CHANGED, COUNTRY_ADDED/DELETED, RIGHTS_CHANGED, etc.**
...
### Administration
- **User management with lock/unlock, email validation**
...
- **2FA**
- **Dashboard customization: displayed elements, colors, TOP3, PDF export, etc.**
- **Full i18n for all pages**
- **Activity tracking: allow file attachments to activity entries**
- **Shared multi-user activity tracking with user-identification TAGs**
- **Automation section: script storage by type, environment, tag, YAML files**
